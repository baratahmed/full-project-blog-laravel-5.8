...
@section('content')
	...
	<div class="card">
		<div class="card-header ">
			<h3 class="text-success">Edit Blog Settings</h3>
		</div>
		<div class="card-body">
			...
			<div class="form-group">
				...
				<input type="text" name="site_name" value="{{$settings->site_name}}" id="site_name" class="form-control">
			</div>
			<div class="form-group">
            ...
            <div class="form-group">
				...
				<input type="text" name="contact_email" id="contact_email" value="{{$settings->contact_email}}" class="form-control">
			</div>
			<div class="form-group">
